...
export function DashboardOverview() {
  ...
  const metrics = summary ? [
    ["Agencies", summary.totalAgencies, `${summary.activeAgencies} active`, Building2, "/agencies"],
    ["Branches", summary.totalBranches, "Operating locations", Map, "/branches"],
    ["Agents", summary.totalAgents, "Team members", Users, "/agents"],
    ["Buses", summary.totalBuses, "Fleet vehicles", Bus, "/buses"],
    ["Drivers", summary.totalDrivers, "Licensed staff", UserRound, "/drivers"],
    ["Routes", summary.totalRoutes, "Configured journeys", RouteIcon, "/routes"],
    ["Trips", summary.totalTrips, "Scheduled operations", Activity, "/trips"],
  ] as const : [];
  return <>
    <PageHeader title="Super Admin dashboard" description="Platform wide view of agencies, teams, fleet, routes, and trips." action={<Link className="button button-secondary" href="/agencies">Manage agencies <ArrowRight size={16} /></Link>} />
